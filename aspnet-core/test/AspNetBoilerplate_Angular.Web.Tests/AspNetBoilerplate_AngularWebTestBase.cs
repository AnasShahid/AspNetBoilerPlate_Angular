...
{
    public abstract class AspNetBoilerplate_AngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspNetBoilerplate_AngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspNetBoilerplate_AngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspNetBoilerplate_AngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspNetBoilerplate_AngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspNetBoilerplate_AngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspNetBoilerplate_AngularDbContext, Task<T>> func)
        {
            T result;
