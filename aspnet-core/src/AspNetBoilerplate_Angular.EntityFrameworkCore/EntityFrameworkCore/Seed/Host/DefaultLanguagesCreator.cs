...
namespace AspNetBoilerplate_Angular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AspNetBoilerplate_AngularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AspNetBoilerplate_AngularDbContext context)
        {
            _context = context;
        }
